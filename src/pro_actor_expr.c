...
static pro_ref actor_expr_eval(pro_state_ref s, pro_ref ref, pro_expr* t)
{
    ...
    pro_ref out;
    pro_actor_create(s, PRO_DEFAULT_ACTOR_TYPE, behavior, ud, &out);
    pro_release(s, ud);
    return out;
}
...
PRO_INTERNAL
pro_behavior* pro_actor_expr_get_behavior(pro_state_ref s, 

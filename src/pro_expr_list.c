...
PRO_INTERNAL pro_expr_list* pro_expr_list_create(pro_state* s,
 ...
 */
static pro_expr_list* pro_expr_list_tail(pro_state* s, pro_expr_list* t)
{
    if (!t)
        return 0;
    else
...
PRO_INTERNAL pro_expr_list* pro_expr_list_join(pro_state* s, pro_expr_list* o1, pro_expr_list* o2)
{
    assert(o1); // o1 must be an expression but o2 may be null
    pro_expr_list* tail = pro_expr_list_tail(s, o1);
    tail->next = o2;
    return o1;
}
